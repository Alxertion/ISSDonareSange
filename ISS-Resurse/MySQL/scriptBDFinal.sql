...
INSERT INTO `analiza` VALUES (1,'B(III)','\0'),(2,'A(II)',''),(3,'O(I)',''),(4,'O(I)','\0'),(5,'AB(IV)',''),(6,'AB(IV)','\0');
INSERT INTO `bolianaliza` VALUES (1,8);
INSERT INTO `cont` VALUES ('chise_b','pass'),('chise_boby','pass3'),('chise_bogdan','pass2'),('personal1','personal1'),('personal12','personal2'),('root','root'),('roots','roots'),('test','test');
...
INSERT INTO `donator` VALUES (1,'Boros','Otniel','chise_bogdan',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1770725055098','chise_b@yahoo.com',NULL),(2,'Chise','Bogdan','chise_boby',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1270725055088','chise_bogdan@yahoo.com',NULL),(3,'Boros','Florin','chise_b',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'1770725055094','oti_otniel97@yahoo.com',NULL);
